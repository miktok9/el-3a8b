...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "🏛️ Ιστορία των αρχαίων γυναικών!\n\n#Ιστορία #ΑρχαίεςΓυναίκες #ΕλληνικήΙστορία #Εκπαίδευση"
        ...
        video = upload.video(
            ...
            name=title or 'Ιστορία των αρχαίων γυναικών',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Ιστορία των αρχαίων γυναικών! 🏛️"
    title = sys.argv[3] if len(sys.argv) > 3 else "Ιστορία των αρχαίων γυναικών"
